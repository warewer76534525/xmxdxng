...
public class GroupAdapter extends CursorAdapter {
	...
	public void bindView(View view, Context context, Cursor cursor) {
		TextView txtGroupName = (TextView) view.findViewById(R.id.txtGroup);
		txtGroupName.setText(cursor.getString(cursor.getColumnIndexOrThrow("name")));
	...
	public View newView(Context context, Cursor cursor, ViewGroup parent) {
		...
		View v = inflater.inflate(R.layout.group_list_row, parent, false);
